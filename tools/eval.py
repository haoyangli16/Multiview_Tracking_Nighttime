...
from toolkit.datasets import UAVDataset, NAT_LDataset, UAVDARK70Dataset, NATDataset,UAVDARK135Dataset
from toolkit.evaluation import OPEBenchmark


parser = argparse.ArgumentParser(description='tracking evaluation')
parser.add_argument('--tracker_path', '-p', type=str, default='/data2/user_backup/lhy/MVDANT-web/results_web', # './results', './hp_search_results/checkpoint_e17'
                    help='tracker result path')
parser.add_argument('--dataset', '-d', type=str, default='UAVDark70',  # UAVDark70, NAT_L, NAT, UAVDark135
                    help='dataset name')
