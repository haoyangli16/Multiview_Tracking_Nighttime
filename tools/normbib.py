...
parser.add_argument('-I','--input',type=str,default="/home/user/V4R/LHY/MDAT/UDAT/CAR/tools/ref.bib")
parser.add_argument('-O','--output',type=str,default="/home/user/V4R/LHY/MDAT/UDAT/CAR/tools/ref_cap.bib")
