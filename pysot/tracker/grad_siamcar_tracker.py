...
class SiamCARTracker(SiameseTracker):
    ...
    def init(self, img, bbox, flag=None):
        """
        args:
    ...
    def track(self, img, idx,video_name, hp, flag=None):
        """
        args:
            img(np.ndarray): BGR image
        return:
        ...
        x_crop = self.get_subwindow(img, self.center_pos,
                                    ...
                                    round(s_x), self.channel_average, flag)
        ...
        mask_d, im_d=self.return_subwindow(img, self.center_pos,
                                    cfg.TRACK.INSTANCE_SIZE,
        ...
        output_dir = '/home/mist/project/visualization/figs/{}_udat/'.format(video_name)
